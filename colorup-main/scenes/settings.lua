...
function scene:create( event )
    ...
    local lblSoundsTitle = display.newText("Звуки", _CX - 80, _CY - 50, "assets/fonts/Galada.ttf", 22)
    ...
    local lblMusicTitle = display.newText("Музыка", _CX + 80, _CY - 50, "assets/fonts/Galada.ttf", 22)
    ...
    -- Created by
    local lblCreatedby = display.newText("Created by DevTop Studio", _CX, _H - 100, "assets/fonts/Galada.ttf", 22)
    ...
    -- Credits
    local lblCredit = display.newText("Музыка by www.soundimage.org", _CX, _H - 30, "assets/fonts/Galada.ttf", 12)
